...
p;18;_CPCibObjectData.jI;20;Foundation/CPArray.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;7;CPCib.ji;16;CPCibConnector.ji;23;CPCibControlConnector.ji;22;CPCibOutletConnector.jc;6111;
...
p;15;CPApplication.jI;21;Foundation/CPBundle.ji;17;CPCompatibility.ji;9;CPEvent.ji;8;CPMenu.ji;13;CPResponder.ji;22;CPDocumentController.ji;14;CPThemeBlend.ji;14;CPCibLoading.ji;12;CPPlatform.jc;18471;
...
return objj_msgSend(_delegate,"application:openFile:",_9f,_a1);
}else{
return objj_msgSend(_documentController,"openDocumentWithContentsOfURL:display:error:",_a1,YES,NULL);
}
}
})]);
...
p;15;CPTableColumn.jI;25;Foundation/CPDictionary.jI;21;Foundation/CPObject.jI;29;Foundation/CPSortDescriptor.jI;21;Foundation/CPString.ji;19;CPTableHeaderView.jc;8402;
...
p;13;CPTableView.jI;20;Foundation/CPArray.ji;11;CPControl.ji;15;CPTableColumn.ji;15;_CPCornerView.ji;12;CPScroller.jc;40812;
...
var _c6=objj_msgSend(_c3,"bounds");
if(!CGRectIntersectsRect(_c5,_c6)){
return CPMakeRange(0,0);
}
var _c7=objj_msgSend(_c3,"rowAtPoint:",_c5.origin);
if(_c7<0){
_c7=0;
}
var _c8=objj_msgSend(_c3,"rowAtPoint:",{x:0,y:(_c5.origin.y+_c5.size.height)});
if(_c8<0){
_c8=_numberOfRows-1;
}
...
objj_msgSend(_ea,"tile");
}
}),new objj_method(sel_getUid("tile"),function(_ec,_ed){
with(_ec){
if(_dirtyTableColumnRangeIndex!==CPNotFound){
objj_msgSend(_ec,"_recalculateTableColumnRanges");
}
var _ee=_tableColumnRanges.length>0?CPMaxRange(objj_msgSend(_tableColumnRanges,"lastObject")):0,_ef=(_rowHeight+_intercellSpacing.height)*_numberOfRows,_f0=objj_msgSend(_ec,"superview");
if(objj_msgSend(_f0,"isKindOfClass:",objj_msgSend(CPClipView,"class"))){
var _f1=objj_msgSend(_f0,"bounds").size;
_ee=MAX(_f1.width,_ee);
_ef=MAX(_f1.height,_ef);
}
objj_msgSend(_ec,"setFrameSize:",{width:_ee,height:_ef});
objj_msgSend(_ec,"setNeedsLayout");
objj_msgSend(_ec,"setNeedsDisplay:",YES);
}
}),new objj_method(sel_getUid("setDelegate:"),function(_f2,_f3,_f4){
with(_f2){
if(_delegate===_f4){
return;
}
var _f5=objj_msgSend(CPNotificationCenter,"defaultCenter");
if(_delegate){
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewColumnDidMove:"))){
objj_msgSend(_f5,"removeObserver:name:object:",_delegate,CPTableViewColumnDidMoveNotification,_f2);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewColumnDidResize:"))){
objj_msgSend(_f5,"removeObserver:name:object:",_delegate,CPTableViewColumnDidResizeNotification,_f2);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewSelectionDidChange:"))){
objj_msgSend(_f5,"removeObserver:name:object:",_delegate,CPTableViewSelectionDidChangeNotification,_f2);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewSelectionIsChanging:"))){
objj_msgSend(_f5,"removeObserver:name:object:",_delegate,CPTableViewSelectionIsChangingNotification,_f2);
}
}
_delegate=_f4;
...
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewColumnDidMove:"))){
objj_msgSend(_f5,"addObserver:selector:name:object:",_delegate,sel_getUid("tableViewColumnDidMove:"),CPTableViewColumnDidMoveNotification,_f2);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewColumnDidResize:"))){
objj_msgSend(_f5,"addObserver:selector:name:object:",_delegate,sel_getUid("tableViewColumnDidMove:"),CPTableViewColumnDidResizeNotification,_f2);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewSelectionDidChange:"))){
objj_msgSend(_f5,"addObserver:selector:name:object:",_delegate,sel_getUid("tableViewSelectionDidChange:"),CPTableViewSelectionDidChangeNotification,_f2);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("tableViewSelectionIsChanging:"))){
objj_msgSend(_f5,"addObserver:selector:name:object:",_delegate,sel_getUid("tableViewSelectionIsChanging:"),CPTableViewSelectionIsChangingNotification,_f2);
}
}
}),new objj_method(sel_getUid("delegate"),function(_f6,_f7){
with(_f6){
return _delegate;
}
}),new objj_method(sel_getUid("_objectValueForTableColumn:row:"),function(_f8,_f9,_fa,_fb){
with(_f8){
var _fc=objj_msgSend(_fa,"UID"),_fd=_objectValues[_fc];
if(!_fd){
_fd=[];
_objectValues[_fc]=_fd;
}
var _fe=_fd[_fb];
if(_fe===undefined){
_fe=objj_msgSend(_dataSource,"tableView:objectValueForTableColumn:row:",_f8,_fa,_fb);
_fd[_fb]=_fe;
}
return _fe;
}
}),new objj_method(sel_getUid("_exposedRect"),function(_ff,_cmd){
with(_ff){
var _101=objj_msgSend(_ff,"superview");
if(!objj_msgSend(_101,"isKindOfClass:",objj_msgSend(CPClipView,"class"))){
return objj_msgSend(_ff,"bounds");
}
return objj_msgSend(_ff,"convertRect:fromView:",CGRectIntersection(objj_msgSend(_101,"bounds"),objj_msgSend(_ff,"frame")),_101);
}
...
var _104=objj_msgSend(self,"_exposedRect"),_105=objj_msgSend(CPIndexSet,"indexSetWithIndexesInRange:",objj_msgSend(self,"rowsInRect:",_104)),_106=objj_msgSend(self,"columnIndexesInRect:",_104),_107=objj_msgSend(_exposedRows,"copy"),_108=objj_msgSend(_exposedColumns,"copy");
objj_msgSend(_107,"removeIndexes:",_105);
objj_msgSend(_108,"removeIndexes:",_106);
var _109=objj_msgSend(_105,"copy"),_10a=objj_msgSend(_106,"copy");
objj_msgSend(_109,"removeIndexes:",_exposedRows);
objj_msgSend(_10a,"removeIndexes:",_exposedColumns);
var _10b=objj_msgSend(_105,"copy"),_10c=objj_msgSend(_106,"copy");
objj_msgSend(_10b,"removeIndexes:",_109);
objj_msgSend(_10c,"removeIndexes:",_10a);
objj_msgSend(self,"_unloadDataViewsInRows:columns:",_10b,_108);
objj_msgSend(self,"_unloadDataViewsInRows:columns:",_107,_10c);
objj_msgSend(self,"_unloadDataViewsInRows:columns:",_107,_108);
objj_msgSend(self,"_loadDataViewsInRows:columns:",_10b,_10a);
objj_msgSend(self,"_loadDataViewsInRows:columns:",_109,_10c);
objj_msgSend(self,"_loadDataViewsInRows:columns:",_109,_10a);
_exposedRows=_105;
_exposedColumns=_106;
objj_msgSend(_tableDrawView,"setFrame:",_104);
objj_msgSend(_tableDrawView,"display");
for(identifier in _cachedDataViews){
var _10d=_cachedDataViews[identifier],_10e=_10d.length;
while(_10e--){
objj_msgSend(_10d[_10e],"removeFromSuperview");
}
}
}
}),new objj_method(sel_getUid("_unloadDataViewsInRows:columns:"),function(self,_cmd,rows,_112){
with(self){
if(!objj_msgSend(rows,"count")||!objj_msgSend(_112,"count")){
return;
}
var _113=[],_114=[];
objj_msgSend(rows,"getIndexes:maxCount:inIndexRange:",_113,-1,nil);
objj_msgSend(_112,"getIndexes:maxCount:inIndexRange:",_114,-1,nil);
var _115=0,_116=_114.length;
for(;_115<_116;++_115){
var _117=_114[_115],_118=_tableColumns[_117],_119=objj_msgSend(_118,"UID");
var _11a=0,_11b=_113.length;
for(;_11a<_11b;++_11a){
var row=_113[_11a],_11d=_dataViewsForTableColumns[_119][row];
_dataViewsForTableColumns[_119][row]=nil;
if(!_cachedDataViews[_11d.identifier]){
_cachedDataViews[_11d.identifier]=[_11d];
}else{
_cachedDataViews[_11d.identifier].push(_11d);
}
}
}
}
}),new objj_method(sel_getUid("_loadDataViewsInRows:columns:"),function(self,_cmd,rows,_121){
with(self){
if(!objj_msgSend(rows,"count")||!objj_msgSend(_121,"count")){
return;
}
var _122=[],_123=[],_124=[];
objj_msgSend(rows,"getIndexes:maxCount:inIndexRange:",_122,-1,nil);
objj_msgSend(_121,"getIndexes:maxCount:inIndexRange:",_124,-1,nil);
if(_dirtyTableColumnRangeIndex!==CPNotFound){
objj_msgSend(self,"_recalculateTableColumnRanges");
}
var _125=0,_126=_124.length;
for(;_125<_126;++_125){
var _127=_124[_125],_128=_tableColumns[_127],_129=objj_msgSend(_128,"UID"),_12a=_tableColumnRanges[_127];
if(!_dataViewsForTableColumns[_129]){
_dataViewsForTableColumns[_129]=[];
}
var _12b=0,_12c=_122.length;
for(;_12b<_12c;++_12b){
var row=_122[_12b],_12e=objj_msgSend(_128,"_newDataViewForRow:",row),_12f=_123[row];
if(!_12f){
_12f=_123[row]=objj_msgSend(self,"rectOfRow:",row);
}
objj_msgSend(_12e,"setFrame:",{origin:{x:_12a.location,y:(_12f.origin.y)},size:{width:_12a.length,height:(_12f.size.height)}});
objj_msgSend(_12e,"setObjectValue:",objj_msgSend(self,"_objectValueForTableColumn:row:",_128,row));
if(objj_msgSend(_12e,"superview")!==self){
objj_msgSend(self,"addSubview:",_12e);
}
_dataViewsForTableColumns[_129][row]=_12e;
}
}
}
}),new objj_method(sel_getUid("setFrameSize:"),function(self,_cmd,_132){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPControl")},"setFrameSize:",_132);
objj_msgSend(_headerView,"setFrameSize:",CGSizeMake(_132.width,objj_msgSend(_headerView,"frame").size.height));
}
}),new objj_method(sel_getUid("exposedClipRect"),function(self,_cmd){
with(self){
var _135=objj_msgSend(self,"superview");
if(!objj_msgSend(_135,"isKindOfClass:",objj_msgSend(CPClipView,"class"))){
return objj_msgSend(self,"bounds");
}
return objj_msgSend(self,"convertRect:fromView:",CGRectIntersection(objj_msgSend(_135,"bounds"),objj_msgSend(self,"frame")),_135);
}
}),new objj_method(sel_getUid("_drawRect:"),function(self,_cmd,_138){
with(self){
var _139=objj_msgSend(self,"_exposedRect");
objj_msgSend(self,"drawBackgroundInClipRect:",_139);
objj_msgSend(self,"highlightSelectionInClipRect:",_139);
objj_msgSend(self,"drawGridInClipRect:",_139);
}
}),new objj_method(sel_getUid("drawBackgroundInClipRect:"),function(self,_cmd,_13c){
with(self){
if(!objj_msgSend(self,"usesAlternatingRowBackgroundColors")){
return;
}
var _13d=objj_msgSend(self,"alternatingRowBackgroundColors"),_13e=objj_msgSend(_13d,"count");
if(_13e===0){
return;
}
var _13f=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort");
if(_13e===1){
CGContextSetFillColor(_13f,_13d[0]);
CGContextFillRect(_13f,_13c);
return;
}
var _140=objj_msgSend(self,"rowsInRect:",_13c),_141=_140.location,_142=CPMaxRange(_140)-1,_143=MIN(_140.length,_13e),_144=0;
while(_143--){
var row=_141%_13e+_141+_143,_146=nil;
CGContextBeginPath(_13f);
for(;row<=_142;row+=_13e){
CGContextAddRect(_13f,CGRectIntersection(_13c,_146=objj_msgSend(self,"rectOfRow:",row)));
}
if(row-_13e===_142){
_144=(_146.origin.y+_146.size.height);
}
CGContextClosePath(_13f);
CGContextSetFillColor(_13f,_13d[_143]);
CGContextFillPath(_13f);
}
var _147=(_13c.origin.y+_13c.size.height);
if(_144>=_147||_rowHeight<=0){
return;
}
var _148=_rowHeight+_intercellSpacing.height,_146={origin:{x:(_13c.origin.x),y:(_13c.origin.y)+_144},size:{width:(_13c.size.width),height:_148}};
for(row=_142+1;_144<_147;++row){
CGContextSetFillColor(_13f,_13d[row%_13e]);
CGContextFillRect(_13f,_146);
_144+=_148;
_146.origin.y+=_148;
}
}
}),new objj_method(sel_getUid("drawGridInClipRect:"),function(self,_cmd,_14b){
with(self){
var _14c=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort"),_14d=objj_msgSend(self,"gridStyleMask");
if(!(_14d&(CPTableViewSolidHorizontalGridLineMask|CPTableViewSolidVerticalGridLineMask))){
return;
}
CGContextBeginPath(_14c);
if(_14d&CPTableViewSolidHorizontalGridLineMask){
var _14e=objj_msgSend(self,"rowsInRect:",_14b);
row=_14e.location,lastRow=CPMaxRange(_14e)-1,rowY=0,minX=(_14b.origin.x),maxX=(_14b.origin.x+_14b.size.width);
for(;row<=lastRow;++row){
var _150=objj_msgSend(self,"rectOfRow:",row),rowY=(_150.origin.y+_150.size.height)-0.5;
CGContextMoveToPoint(_14c,minX,rowY);
CGContextAddLineToPoint(_14c,maxX,rowY);
}
if(_rowHeight>0){
var _151=_rowHeight+_intercellSpacing.height,_152=(_14b.origin.y+_14b.size.height);
while(rowY<_152){
rowY+=_151;
CGContextMoveToPoint(_14c,minX,rowY);
CGContextAddLineToPoint(_14c,maxX,rowY);
...
if(_14d&CPTableViewSolidVerticalGridLineMask){
var _153=objj_msgSend(self,"columnIndexesInRect:",_14b),_154=[];
objj_msgSend(_153,"getIndexes:maxCount:inIndexRange:",_154,-1,nil);
var _155=0,_156=_154.length,minY=(_14b.origin.y),maxY=(_14b.origin.y+_14b.size.height);
for(;_155<_156;++_155){
var _159=objj_msgSend(self,"rectOfColumn:",_155),_15a=(_159.origin.x+_159.size.width)-0.5;
CGContextMoveToPoint(_14c,_15a,minY);
CGContextAddLineToPoint(_14c,_15a,maxY);
}
}
CGContextClosePath(_14c);
CGContextSetStrokeColor(_14c,_gridColor);
CGContextStrokePath(_14c);
}
}),new objj_method(sel_getUid("highlightSelectionInClipRect:"),function(self,_cmd,_15d){
with(self){
...
var _15e=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort"),_15f=[],_160=sel_getUid("rectOfRow:");
if(objj_msgSend(_selectedRowIndexes,"count")>=1){
var _161=objj_msgSend(CPIndexSet,"indexSetWithIndexesInRange:",objj_msgSend(self,"rowsInRect:",_15d)),_162=objj_msgSend(_161,"firstIndex"),_163=CPMakeRange(_162,objj_msgSend(_161,"lastIndex")-_162+1);
objj_msgSend(_selectedRowIndexes,"getIndexes:maxCount:inIndexRange:",_15f,-1,_163);
}else{
if(objj_msgSend(_selectedColumnIndexes,"count")>=1){
_160=sel_getUid("rectOfColumn:");
var _164=objj_msgSend(self,"columnIndexesInRect:",_15d),_165=objj_msgSend(_164,"firstIndex"),_163=CPMakeRange(_165,objj_msgSend(_164,"lastIndex")-_165+1);
objj_msgSend(_selectedColumnIndexes,"getIndexes:maxCount:inIndexRange:",_15f,-1,_163);
}
}
var _166=objj_msgSend(_15f,"count");
if(!_166){
return;
}
CGContextBeginPath(_15e);
while(_166--){
CGContextAddRect(_15e,CGRectIntersection(objj_msgSend(self,_160,_15f[_166]),_15d));
}
CGContextClosePath(_15e);
CGContextFillPath(_15e);
}
}),new objj_method(sel_getUid("layoutSubviews"),function(self,_cmd){
with(self){
objj_msgSend(self,"load");
}
}),new objj_method(sel_getUid("viewWillMoveToSuperview:"),function(self,_cmd,_16b){
with(self){
var _16c=objj_msgSend(self,"superview"),_16d=objj_msgSend(CPNotificationCenter,"defaultCenter");
if(_16c){
objj_msgSend(_16d,"removeObserver:name:object:",self,CPViewFrameDidChangeNotification,_16c);
objj_msgSend(_16d,"removeObserver:name:object:",self,CPViewBoundsDidChangeNotification,_16c);
}
if(_16b){
objj_msgSend(_16b,"setPostsFrameChangedNotifications:",YES);
objj_msgSend(_16b,"setPostsBoundsChangedNotifications:",YES);
objj_msgSend(_16d,"addObserver:selector:name:object:",self,sel_getUid("superviewFrameChanged:"),CPViewFrameDidChangeNotification,_16b);
objj_msgSend(_16d,"addObserver:selector:name:object:",self,sel_getUid("superviewBoundsChanged:"),CPViewBoundsDidChangeNotification,_16b);
}
}
}),new objj_method(sel_getUid("superviewBoundsChanged:"),function(self,_cmd,_170){
with(self){
objj_msgSend(self,"setNeedsDisplay:",YES);
objj_msgSend(self,"setNeedsLayout");
}
}),new objj_method(sel_getUid("superviewFrameChanged:"),function(self,_cmd,_173){
with(self){
objj_msgSend(self,"tile");
}
...
}),new objj_method(sel_getUid("startTrackingAt:"),function(self,_cmd,_178){
with(self){
var row=objj_msgSend(self,"rowAtPoint:",_178);
...
}),new objj_method(sel_getUid("continueTracking:at:"),function(self,_cmd,_17c,_17d){
with(self){
objj_msgSend(self,"_updateSelectionWithMouseAtRow:",objj_msgSend(self,"rowAtPoint:",_17d));
return YES;
}
}),new objj_method(sel_getUid("stopTracking:at:mouseIsUp:"),function(self,_cmd,_180,_181,_182){
with(self){
}
...
var _186=[];
objj_msgSend(newSelection,"getIndexes:maxCount:inIndexRange:",_186,-1,nil);
var _187=_186.length;
while(_187--){
var _188=_186[_187];
if(!objj_msgSend(_delegate,"tableView:shouldSelectRow:",self,_188)){
objj_msgSend(newSelection,"removeIndex:",_188);
}
}
}
...
var _189="CPTableViewDataSourceKey",_18a="CPTableViewDelegateKey",_18b="CPTableViewHeaderViewKey",_18c="CPTableViewTableColumnsKey",_18d="CPTableViewRowHeightKey",_18e="CPTableViewIntercellSpacingKey",_18f="CPTableViewMultipleSelectionKey",_190="CPTableViewEmptySelectionKey";
...
var _1c=_1b.isa;
class_addMethods(_1b,[new objj_method(sel_getUid("initWithCoder:"),function(self,_cmd,_193){
with(self){
objj_msgSend(self,"init");
self=objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPControl")},"initWithCoder:",_193);
if(self){
_dataSource=objj_msgSend(_193,"decodeObjectForKey:",_189);
_delegate=objj_msgSend(_193,"decodeObjectForKey:",_18a);
_rowHeight=objj_msgSend(_193,"decodeFloatForKey:",_18d);
_intercellSpacing=objj_msgSend(_193,"decodeSizeForKey:",_18e);
_allowsMultipleSelection=objj_msgSend(_193,"decodeBoolForKey:",_18f);
_allowsEmptySelection=objj_msgSend(_193,"decodeBoolForKey:",_190);
_tableColumns=objj_msgSend(_193,"decodeObjectForKey:",_18c);
...
}),new objj_method(sel_getUid("encodeWithCoder:"),function(self,_cmd,_196){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPControl")},"encodeWithCoder:",_196);
objj_msgSend(_196,"encodeObject:forKey:",_dataSource,_189);
objj_msgSend(_196,"encodeObject:forKey:",_delegate,_18a);
objj_msgSend(_196,"encodeFloat:forKey:",_rowHeight,_18d);
objj_msgSend(_196,"encodeSize:forKey:",_intercellSpacing,_18e);
objj_msgSend(_196,"encodeBool:forKey:",_allowsMultipleSelection,_18f);
objj_msgSend(_196,"encodeBool:forKey:",_allowsEmptySelection,_190);
objj_msgSend(_196,"encodeObject:forKey:",_tableColumns,_18c);
}
})]);
